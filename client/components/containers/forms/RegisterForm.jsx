...
const RegisterForm = ({ user = {} }) => {
  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col space-y-8 p-6 bg-white shadow-md rounded-lg">
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-semibold text-gray-700">Personal Information</h2>
      ...
      <section className="space-y-6">
        <h2 className="text-3xl font-semibold text-gray-700">Medical Information</h2>
      ...
      <SubmitButton isLoading={isLoading} text="Submit" className="mt-4" />
    </form>
  );
};
