        ...
        <div className="flex items-center">
          ...
          {isAuthenticated ? (
            <>
              ...
              {user?.role === 'doctor' && (
                <Link href="/doctor-portal" className="mx-4 text-font-color text-base font-medium uppercase">Doctor Portal</Link>
              )}
              {user?.role === 'patient' && (
                <>
            ...
            <>
              <Link href="/signin" className="mx-4 text-font-color text-base font-medium uppercase">Sign In</Link>
              <Link href="/signup" className="mx-4 text-font-color text-base font-medium uppercase">Sign Up</Link>
            </>
          )}
        </div>
      </nav>
