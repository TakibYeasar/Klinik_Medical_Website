...
// SignInModal and SignUpModal Components
    ...
    <div>
      ...
      <nav className="bg-bg-color flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          <button onClick={() => setShowSignIn(true)} className="mt-2 mb-2 ml-4 mr-4 text-font-color text-base font-medium uppercase outline-none no-underline hover:text-primary-color">Sign In</button>
          <button onClick={() => setShowSignUp(true)} className="mt-2 mb-2 ml-4 mr-4 text-font-color text-base font-medium uppercase outline-none no-underline hover:text-primary-color">Sign Up</button>
