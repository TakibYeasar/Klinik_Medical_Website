...
export { default as MedicalRecordsAccess } from "./patients/MedicalRecordsAccess";
export { default as HealthTracking } from "./patients/HealthTracking";
export { default as PaymentHistory } from "./patients/PaymentHistory";
